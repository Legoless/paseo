...
describe("translation resources", () => {
  ...
  it("includes Settings expansion keys for the Batch 3A migration", () => {
    ...
    expect(en.settings.appearance.paneStatusGlow.title).toBe("Pane status glow");
    expect(en.settings.appearance.terminalStatusGlow.title).toBe("Terminal agent glow");
