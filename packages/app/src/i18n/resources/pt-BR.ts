...
export const ptBR = {
  ...
  workspace: {
    ...
    hoverCard: {
      ...
      openTabs: "Abas abertas: {{count}}",
      projects: "Projetos: {{count}}",
    ...
    commands: {
      ...
      errors: {
        noTarget: "Nenhuma aba de chat ou terminal para executar este comando",
  ...
  openProject: {
    tiles: {
      addAgent: {
        title: "Novo agente",
        description: "Descreva uma tarefa e escolha um projeto",
      },
      addProject: {
  ...
  settings: {
    commands: {
      ...
      invalidShortcut: "Este atalho não pode ser usado. Grave um novo.",
