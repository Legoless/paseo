...
export const zhCN = {
  ...
  agentPanel: {
    states: {
      ...
      archivingTitle: "正在关闭 Agent...",
      archivingSubtitle: "请稍候，我们正在关闭这个 Agent。",
    },
    unavailable: {
  ...
  agentList: {
    ...
    archiveSheet: {
      hostOffline: "Host 离线",
      runningAgent: "此 Agent 仍在运行。关闭会停止该 Agent。",
      archive: "关闭",
    },
  },
  message: {
  ...
  workspace: {
    route: {
      ...
      manageHost: "管理 Host",
      recovery: {
        archivedTitle: "Workspace 已关闭",
        restoreDescription:
          "{{workspaceName}} 已关闭，其 worktree 已移除。恢复分支 {{branch}} 以重新打开。",
        unarchiveDescription: "{{workspaceName}} 已关闭。重新打开以继续。",
        restoreAction: "恢复",
        unarchiveAction: "重新打开",
    ...
    tabs: {
      ...
      confirmations: {
        ...
        switchProject: "切换",
        archiveRunningAgentTitle: "关闭正在运行的 Agent？",
        archiveRunningAgentMessage: "此 Agent 仍在运行。关闭会停止该 Agent 并关闭标签。",
        closeTabsLeftTitle: "关闭左侧标签？",
        closeTabsRightTitle: "关闭右侧标签？",
        closeOtherTabsTitle: "关闭其他标签？",
        bulk: {
          all: "这会关闭 {{agents}} 个 Agent，关闭 {{terminals}} 个 Terminal，并关闭 {{tabs}} 个标签。已关闭 Terminal 中任何正在运行的进程都会立即停止。",
          agentsAndTerminals:
            "这会关闭 {{agents}} 个 Agent，并关闭 {{terminals}} 个 Terminal。已关闭 Terminal 中任何正在运行的进程都会立即停止。",
          terminalsAndTabs:
            "这会关闭 {{terminals}} 个 Terminal，并关闭 {{tabs}} 个标签。已关闭 Terminal 中任何正在运行的进程都会立即停止。",
          agentsAndTabs: "这会关闭 {{agents}} 个 Agent，并关闭 {{tabs}} 个标签。",
          terminals:
            "这会关闭 {{terminals}} 个 Terminal。已关闭 Terminal 中任何正在运行的进程都会立即停止。",
          tabs: "这会关闭 {{tabs}} 个标签。",
          agents: "这会关闭 {{agents}} 个 Agent。",
        },
      },
    },
    header: {
    ...
    git: {
      ...
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree: "此处无法关闭，因为此 workspace 不是作为 Paseo worktree 创建的",
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        remove: "关闭 project",
        removeFromWorkspace: "关闭 project",
        moveToWorkspace: "移动到 workspace",
        noOtherWorkspaces: "没有其他 workspace",
        removing: "正在关闭...",
      },
      confirmations: {
        removeTitle: "关闭 project？",
        removeMessage: "关闭「{{projectName}}」？\n\n磁盘上的文件不会被更改。",
        removeConfirm: "关闭",
        cancel: "取消",
      },
      toasts: {
        ...
        updateHostToRemove: "更新 host 以关闭 projects。",
      },
      empty: {
        title: "还没有 projects",
    ...
    agent: {
      ...
      confirmations: {
        archiveTitle: "关闭 Agent？",
        archiveMessage: "此 Agent 将被关闭。",
      },
    },
  },
  newWorkspace: {
  ...
  settings: {
    commands: {
      ...
      submit: "立即提交",
      shortcut: "键盘快捷键（可选）",
      invalidShortcut: "此快捷键无法使用。请重新录制。",
