...
export const ja = {
  ...
  agentPanel: {
    states: {
      ...
      archivingSubtitle: "このエージェントを閉じるまでお待ちください。",
    },
    unavailable: {
  ...
  agentList: {
    ...
    archiveSheet: {
      ...
      runningAgent: "このエージェントはまだ実行中です。閉じるとエージェントが停止します。",
      archive: "閉じる",
    },
  },
  message: {
  ...
  workspace: {
    route: {
      ...
      manageHost: "ホストを管理",
      recovery: {
        archivedTitle: "ワークスペースは閉じられています",
        restoreDescription:
          "{{workspaceName}} は閉じられ、worktree が削除されました。ブランチ {{branch}} を復元して再度開きます。",
        unarchiveDescription: "{{workspaceName}} は閉じられています。再度開いてください。",
        restoreAction: "復元",
        unarchiveAction: "再度開く",
    ...
    tabs: {
      ...
      confirmations: {
        ...
        switchProject: "切り替える",
        archiveRunningAgentTitle: "実行中のエージェントを閉じますか？",
        archiveRunningAgentMessage:
          "このエージェントはまだ実行中です。閉じるとエージェントが停止してタブが閉じられます。",
        closeTabsLeftTitle: "左のタブを閉じますか？",
        closeTabsRightTitle: "右のタブを閉じますか？",
        closeOtherTabsTitle: "他のタブを閉じますか？",
        bulk: {
          all: "{{agents}}件のエージェントを閉じ、{{terminals}}件のターミナルを閉じ、{{tabs}}件のタブを閉じます。閉じたターミナルで実行中のプロセスはすぐに停止されます。",
          agentsAndTerminals:
            "{{agents}}件のエージェントを閉じ、{{terminals}}件のターミナルを閉じます。閉じたターミナルで実行中のプロセスはすぐに停止されます。",
          terminalsAndTabs:
            "{{terminals}}件のターミナルを閉じ、{{tabs}}件のタブを閉じます。閉じたターミナルで実行中のプロセスはすぐに停止されます。",
          agentsAndTabs: "{{agents}}件のエージェントを閉じ、{{tabs}}件のタブを閉じます。",
          terminals:
            "{{terminals}}件のターミナルを閉じます。閉じたターミナルで実行中のプロセスはすぐに停止されます。",
          tabs: "{{tabs}}件のタブを閉じます。",
          agents: "{{agents}}件のエージェントを閉じます。",
        },
      },
    },
    header: {
    ...
    commands: {
      ...
      errors: {
        noTarget: "このコマンドを実行するチャットまたはターミナルタブがありません",
    ...
    git: {
      ...
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "このワークスペースはPaseoワークツリーとして作成されていないため、閉じる操作はここでは利用できません",
  ...
  sidebar: {
    ...
    project: {
      actions: {
        ...
        remove: "プロジェクトを閉じる",
        removeFromWorkspace: "プロジェクトを閉じる",
        moveToWorkspace: "ワークスペースに移動",
        noOtherWorkspaces: "他のワークスペースがありません",
        removing: "閉じています...",
      },
      confirmations: {
        removeTitle: "プロジェクトを閉じますか？",
        removeMessage: '"{{projectName}}"を閉じますか？\n\nディスク上のファイルは変更されません。',
        removeConfirm: "閉じる",
        cancel: "キャンセル",
      },
      toasts: {
        ...
        updateHostToRemove: "プロジェクトを閉じるにはホストを更新してください。",
      },
      empty: {
    ...
    workspace: {
      ...
      toasts: {
        ...
        archiveFailed: "ワークスペースを閉じるのに失敗しました",
      },
      uncategorized: "未分類",
    },
    agent: {
      ...
      confirmations: {
        archiveTitle: "エージェントを閉じますか？",
        archiveMessage: "このエージェントは閉じられます。",
      },
    },
  },
  newWorkspace: {
  ...
  subagents: {
    ...
    archiveAction: "{{label}}を閉じる",
    archiveTooltip: "サブエージェントを閉じる",
    archiveFinishedAction: "完了したサブエージェントを閉じる",
  ...
  settings: {
    commands: {
      ...
      text: "コマンドのテキスト",
      submit: "すぐに送信",
      shortcut: "キーボードショートカット（任意）",
      invalidShortcut: "このショートカットは使用できません。新しく記録してください。",
      ...
      loadError: "コマンドを読み込めませんでした",
      empty: "コマンドはまだありません。追加すると、このホストの各プロジェクトで使えます。",
    },
    title: "設定",
    loading: "設定を読み込み中...",
    groups: {
