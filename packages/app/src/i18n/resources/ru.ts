...
export const ru = {
  ...
  workspace: {
    ...
    tabs: {
      ...
      projectSelector: {
        ...
        leaveProject: "Работать вне проекта",
    ...
    commands: {
      ...
      errors: {
        noTarget: "Нет вкладки чата или терминала для выполнения этой команды",
  ...
  settings: {
    commands: {
      ...
      name: "Название",
      text: "Текст команды",
      submit: "Отправлять сразу",
      shortcut: "Сочетание клавиш (необязательно)",
      invalidShortcut: "Это сочетание нельзя использовать. Запишите новое.",
      ...
      empty: "Команд пока нет. Добавьте команду для использования в проектах этого хоста.",
    },
    title: "Настройки",
