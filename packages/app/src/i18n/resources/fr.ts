...
export const fr = {
  ...
  workspace: {
    ...
    tabs: {
      ...
      projectSelector: {
        ...
        leaveProject: "Travailler hors projet",
    ...
    commands: {
      ...
      errors: {
        noTarget: "Aucun onglet de discussion ou de terminal pour exécuter cette commande",
  ...
  openProject: {
    tiles: {
      addAgent: {
        title: "Nouvel agent",
        description: "Décrivez une tâche et choisissez un projet",
      },
      addProject: {
  ...
  settings: {
    commands: {
      ...
      invalidShortcut: "Ce raccourci est inutilisable. Enregistrez-en un nouveau.",
