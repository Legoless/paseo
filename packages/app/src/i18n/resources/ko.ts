...
export const ko = {
  ...
  workspace: {
    ...
    commands: {
      ...
      errors: {
        noTarget: "이 명령을 실행할 채팅 또는 터미널 탭이 없습니다",
  ...
  settings: {
    commands: {
      ...
      text: "명령 텍스트",
      submit: "즉시 전송",
      shortcut: "키보드 단축키 (선택 사항)",
      invalidShortcut: "이 단축키는 사용할 수 없습니다. 새로 기록하세요.",
      ...
      loadError: "명령을 불러올 수 없습니다",
      empty: "아직 명령이 없습니다. 명령을 추가하면 이 호스트의 프로젝트에서 사용할 수 있습니다.",
    },
    title: "설정",
    loading: "설정 불러오는 중...",
    groups: {
