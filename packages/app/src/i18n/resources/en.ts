export const en = {
  ...
  workspace: {
    ...
    commands: {
      ...
      errors: {
        noTarget: "No chat or terminal tab to run this command in",
  ...
  settings: {
    commands: {
      ...
      invalidShortcut: "This shortcut can’t be used. Record a new one.",
      ...
      loadError: "Unable to load commands",
      empty: "No commands yet. Add a command to use it across this host’s projects.",
    },
    title: "Settings",
